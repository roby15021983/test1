...
lxc-attach -n $CTID -- bash -c "$(wget -qLO - https://raw.githubusercontent.com/roby15021983/test/refs/heads/main/vai1.sh?token=GHSAT0AAAAAAC3U6X4CBNGATTWOL7KNX4HQZ2W4FXQ)" || exit
